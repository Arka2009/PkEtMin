...
class ptss_TMINLP : public TMINLP {
    public:
    /// Default constructor.
    ptss_TMINLP() : printSol_(false){}
	...
	/** Copy constructor.*/   
    ptss_TMINLP(const ptss_TMINLP &other) : printSol_(other.printSol_){}
  
    /** Assignment operator. no data = nothing to assign*/
    //ptss_TMINLP& operator=(const ptss_TMINLP&) {}
